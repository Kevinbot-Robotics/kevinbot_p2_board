...
This will work for interfacing with the single sensor on the board, or external sensors via the [One-Wire ports](../board-diagram#11-one-wire-ports).
...
This is the driver for controlling the [servo banks](../board-diagram#22-first-servo-bank).
