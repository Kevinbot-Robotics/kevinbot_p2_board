...
Refer to [Pin Mappings](../pin-mappings) for the internal connections

5v, 3.3v, SDA, SCL, GND starting from the PropPlug side

{{< callout type="warning" >}}
Do not mix-and-match any of the 3.3v rails.
They have the same voltage, but connecting them may result in noisy analog inputs.
{{< /callout >}}
...
Logic level is shifted to the [input](#8-led-power-connector) voltage
...
it will play a startup chime, and continuously beep if an error has occurred.

## 26. Error Buzzer Enabler

<img src="/images/docs/kevinbot-p2-board/jumper.png" class="light-only" alt="Jumper icon">
<img src="/images/docs/kevinbot-p2-board/jumper_dark.png" class="dark-only" alt="Jumper icon">
...
A pinout is provided [here](../pin-mappings)
